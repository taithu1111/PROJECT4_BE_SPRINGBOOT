    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (jwt != null && jwt.startsWith(TOKEN_PREFIX)) {
            ...
            try {
                ...
                // use HMAC-SHA based on SECRET_KEY.getBytes() after can used for asign and
                // authen code jwt
                ...
                // .parseClaimsJwt(jwt).getBody(): decrypt jwt String and return Claims object
                // extract from JWT decrypted
                ...
                // UsernamePasswordAuthenticationToken: represent authen using username and
                // password
                // email: represents ìnfo user, null: common is a password, auths: is role of
                // user
        ...
        // 2. It allowed current filter complete that handle and return result in
        // response for browser
        // 3. When last filter handle string complete, control permission return app for
        // complete request handle and send response browser
