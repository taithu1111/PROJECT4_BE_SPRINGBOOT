...
public interface IProductService {
    ...
    // giảm sluong tồn kho
    Product decreaseStock(Long productId, int quantityToDecrease) throws ProductException;

    //Tăng số lượng tồn kho
    Product increaseStock(Long productId, int quantityToIncrease) throws ProductException;
